...
const SearchBar = () => {
    return (
        <div className='searchbar fixed top-0 left-0 w-full h-full translate-x-full bg-white transition-transform overflow-hidden z-30' style={{ transitionDuration: '700ms' }}>
